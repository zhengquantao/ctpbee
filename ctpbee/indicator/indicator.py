...
class Indicator(HandlerData):
    ...
    def ma(self, data, period=5):
        ...
        for i in range(period, end):
            self.ma_data[i] = sum(data[i-period:i+1])/period
        return self.ma_data

    @getAverageName
    def sma(self, data, period=15):
        """
    ...
    @getAverageName
    def ema(self, data, period: int, alpha=None):
        """
    ...
    @getIndicatorName
    def kd(self, data, period=14, period_dfast=3):
        """
    ...
    @getIndicatorName
    def macd(self, data, period_me1=12, period_me2=26, period_signal=9):
        """
    ...
    @getAverageName
    def rsi(self, data,  period=14, lookback=1):
        """
        rsi 相对强度指数
        Formula:
          - up = upday(data)
    ...
    @getAverageName
    def smma(self, data, period: int, alpha=15):
        """
        smma 平滑移动平均值
    ...
    @getIndicatorName
    def stdDev(self, data, period=20):
        """
    ...
    @getAverageName
    def boll(self, data, period=20, devfactor=2):
        """
    ...
    @getIndicatorName
    def AroonIndicator(self, data, period:int):
        """
        Formula:
    ...
    @getAverageName
    def UltimateOscillator(self, data, period: int):
        '''
            终极振荡器
            Formula:
    ...
    @getIndicatorName
    def trix(self, data, period: int, rocperiod=1):
        '''
